...
#define NVIC_IRQ23_EXTRI5_9_Enable()                  (NVIC_ISER->ISER[0] |= 1<<EXTRI5_9_IRQ  )
#define NVIC_IRQ40_EXTRI10_15_Enable()      		  (NVIC_ISER->ISER[1] |= 1<<EXTRI10_15_IRQ) // 42 - 32 = 8
...
#define NVIC_IRQ23_EXTRI5_9_Disable()                 (NVIC_ICER->ICER[0] |= 1<<EXTRI5_9_IRQ  )
#define NVIC_IRQ40_EXTRI10_15_Disable()      		  (NVIC_ICER->ICER[1] |= 1<<EXTRI10_15_IRQ) // 42 - 32 = 8
...
#define EXTRI5_9_IRQ				  23
#define EXTRI10_15_IRQ				  40
