...
typedef struct
{
    ...
    // the parameters must be set based on @ref GPIO_PINS_define (topic 2 )
	uint16_t GPIO_PinNumber ;
	// specifies the operation mode for the selected pins.
    // the parameters can be value of @ref GPIO_MODE_define (topic 3)
	uint8_t GPIO_MODE       ;
	// specifies the operation speed for the selected pins in order to the pin is output.
	// the parameters can be value of @ref GPIO_OUTPUT_SPEED_define (topic 4)
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#endif /* GPIO_DRIVERS_INCLUDE_STM32F103C6_GPIO_DRIVERS_H_ */
